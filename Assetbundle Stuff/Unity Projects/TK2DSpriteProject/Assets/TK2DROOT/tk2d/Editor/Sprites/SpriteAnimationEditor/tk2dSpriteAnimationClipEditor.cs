...
namespace tk2dEditor.SpriteAnimationEditor
{
	public class ClipEditor
	{
		...
		void DrawClipInspector()
		{
			...
			EditorGUILayout.FloatField("minFidgetDuration", clip.minFidgetDuration);
			EditorGUILayout.FloatField("maxFidgetDuration", clip.maxFidgetDuration);
