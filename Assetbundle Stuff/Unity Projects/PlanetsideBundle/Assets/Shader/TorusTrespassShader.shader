    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float4 node_2273 = _Time;
                float2 node_79 = (mul((i.uv0+node_2273.g*float2(0.025,0.025))-node_79_piv,float2x2( node_79_cos, -node_79_sin, node_79_sin, node_79_cos))+node_79_piv);
