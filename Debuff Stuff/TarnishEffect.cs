	...
	public class TarnishEffect : GameActorHealthEffect
	{
        ...
        public static GameObject BuildVFX()
        {
			...
			*/
            ...
            var debuffCollection = StaticSpriteDefinitions.VFX_Sheet_Data;
            var BrokenArmorVFXObject = ItemBuilder.AddSpriteToObjectAssetbundle("Tarnish VFX", debuffCollection.GetSpriteIdByName("TarnishEffect_idle_001"), debuffCollection);//new GameObject("Broken Armor");//SpriteBuilder.SpriteFromResource("Planetside/Resources/VFX/Debuffs/brokenarmor", new GameObject("BrokenArmorEffect"));
            FakePrefab.MarkAsFakePrefab(BrokenArmorVFXObject);
            UnityEngine.Object.DontDestroyOnLoad(BrokenArmorVFXObject);
            ...
            animator.DefaultClipId = animator.GetClipIdByName("tarnish_effect");
            animator.playAutomatically = true;
