...
namespace Planetside
{
	internal class StormBringerProjectile : MonoBehaviour
	{
        public void Start()
        {
            ...
            {
                projectile.OnHitEnemy += (proj, body, boolb) =>
                {
                    if (body.aiActor != null)
                    {
                        ...
                        c.LightningMajorNodeDelay = 0.02f;
                        c.LightningMinorNodeDelay = 0.02f;
                        ...
                        c.OnPostStrike += (obj1) =>
                        {
                            ...
                            for (int i = 0; i < CoinTosser.AllActiveCoins.Count; i++)
                            {
...

                                {
                                    ...
                                    if (Vector2.Distance(coinSprite.WorldCenter, body.aiActor.sprite.WorldCenter) < 3.5f)
                                    {
                        ...
                        c.GenerateLightning(proj.PossibleSourceGun != null ? proj.PossibleSourceGun.barrelOffset.transform.position : GameManager.Instance.PrimaryPlayer.sprite.WorldCenter.ToVector3XUp(), body.aiActor.sprite.WorldCenter);
                    }
