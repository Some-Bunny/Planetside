    ...
    */
    class Greedy : PerkPickupObject, IPlayerInteractable
    {
        public static void Init()
        {
            ...
            item.InitialPickupNotificationText = "Greed Is Good.";
            item.StackPickupNotificationText = "Greed Is Even Better.";


        }

        public override CustomDungeonFlags FlagToSetOnStack => CustomDungeonFlags.GREEDY_FLAG_STACK;
        ...
        */
        ...
        private IEnumerator GrantTemporaryBoost(PlayerController user, float StatIncreaseValue)
        {
            ...
            {
                statToBoost = PlayerStats.StatType.MovementSpeed,
                amount = (((StatIncreaseValue - 1) * ActiveBuffs) + 1f) * 0.4f,
                modifyType = StatModifier.ModifyMethod.ADDITIVE
            };
            Damage = new StatModifier
            {
                statToBoost = PlayerStats.StatType.Damage,
                amount = (((StatIncreaseValue - 1) * ActiveBuffs) + 1f ) * 0.75f,
                modifyType = StatModifier.ModifyMethod.MULTIPLICATIVE
            };
            user.ownerlessStatModifiers.Add(Speed);
            user.ownerlessStatModifiers.Add(Damage);
        ...
        {
            playerController.OnKilledEnemyContext += this.OnKilledEnemy;
        }
        ...
        private float StatIncrease = 1.05f;
        private float StatIncreaseFlat = 0.05f;
