	...
	public class Observant : AIActor
	{
		...
		public static void BuildPrefab()
		{
			...
			if (!flag2)
			{
				...
				companion.aiActor.healthHaver.ForceSetCurrentHealth(41f);
				...
				companion.aiActor.healthHaver.SetHealthMaximum(41f, null, false);
		...
		public class EnemyBehavior : BraveBehaviour
		{
			...
			private void AnimationEventTriggered(tk2dSpriteAnimator animator, tk2dSpriteAnimationClip clip, int frameIdx)
			{
				...
				if (clip.GetFrame(frameIdx).eventInfo.Contains("Blast"))
				{
					...
					GameObject.Instantiate(silencerVFX.gameObject, base.aiActor.transform.Find("ObservantShootpointLeft").position, Quaternion.identity);
