		...
		public static void Init()
		{
            ...
            if (robotShopkeeperprefab == null || !BossBuilder.Dictionary.ContainsKey(guid))
			{
				...
				*/
				...
				/*
				EnemyToolbox.AddSoundsToAnimationFrame(enemy.aiActor.spriteAnimator, "broken_left", new Dictionary<int, string> {
					{ 1, "Play_DistressSiren" },
				});


				EnemyToolbox.AddSoundsToAnimationFrame(enemy.aiActor.spriteAnimator, "broken_right", new Dictionary<int, string> {
					{ 1, "Play_DistressSiren" },
				});
				*/
				...
				EnemyToolbox.AddSoundsToAnimationFrame(companion.aiActor.spriteAnimator, "intro", new Dictionary<int, string> {
				...
				EnemyToolbox.AddEventTriggersToAnimation(companion.aiActor.spriteAnimator, "intro", new Dictionary<int, string> {
					{ 1, "IntroSpeak1" },
					{ 22, "IntroSpeak2" },
					{ 57, "IntroSpeak3" },
					{ 69, "IntroSpeak4" },
				...
				bs.MovementBehaviors = new List<MovementBehaviorBase>
			{
				...
				*/
                ...
                SpriteBuilder.AddSpriteToCollection(StaticSpriteDefinitions.VFX_Sheet_Data.GetSpriteDefinition("hmprimeAmmoIcon"), SpriteBuilder.ammonomiconCollection);
				...
				companion.encounterTrackable.journalData.AmmonomiconSprite = "hmprimeAmmoIcon";
                ...
                var ent = EnemyBuilder.AddEnemyToDatabase(companion.gameObject, guid, true);
                ent.ForcedPositionInAmmonomicon = 201;
                ent.isNormalEnemy = true;
                ent.isInBossTab = true;
				...
				if (clip.GetFrame(frameIdx).eventInfo.Contains("StopVFX"))
				{
					...
					if (positions != null)
					{
						foreach (var KeysAndValues in positions)
						{
                            ...
                            /*
                            {
								GameObject gameObject = SpawnManager.SpawnVFX(StaticVFXStorage.MachoBraceDustupVFX, true);
