...
namespace Planetside
{
    public static class DungeonRoomFactory
    {
        ...
        {
            if (Planetside.ModPrefabs.shared_auto_001.LoadAsset<GameObject>(assetPath))
            {
                return Planetside.ModPrefabs.shared_auto_001.LoadAsset<GameObject>(assetPath);
            }
            else if (Planetside.ModPrefabs.shared_auto_002.LoadAsset<GameObject>(assetPath))
            {
                return Planetside.ModPrefabs.shared_auto_002.LoadAsset<GameObject>(assetPath);
            }
            else if (Planetside.ModPrefabs.braveResources.LoadAsset<GameObject>(assetPath))
            {
                return Planetside.ModPrefabs.braveResources.LoadAsset<GameObject>(assetPath);
            }
            else
            {
                return null;
        ...
        {
            if (Planetside.ModPrefabs.shared_auto_001.LoadAsset<DungeonPlaceable>(assetPath))
            {
                return Planetside.ModPrefabs.shared_auto_001.LoadAsset<DungeonPlaceable>(assetPath);
            }
            else if (Planetside.ModPrefabs.shared_auto_002.LoadAsset<DungeonPlaceable>(assetPath))
            {
                return Planetside.ModPrefabs.shared_auto_002.LoadAsset<DungeonPlaceable>(assetPath);
            }
            else if (Planetside.ModPrefabs.braveResources.LoadAsset<DungeonPlaceable>(assetPath))
            {
                return Planetside.ModPrefabs.braveResources.LoadAsset<DungeonPlaceable>(assetPath);
            }
            else
            {
                return null;
        ...
        public static GameObject GetGameObjectFromStoredObjects(string assetPath)
        {
            ...
            foreach (var objectlist in GungeonAPI.StaticReferences.StoredRoomObjects)
            {
        ...
        public static DungeonPlaceable GetDungeonPlaceableFromStoredObjects(string assetPath)
        {
            ...
            foreach (var objectlist in GungeonAPI.StaticReferences.StoredDungeonPlaceables)
            {
                if (assetPath == objectlist.Key)
                {
                    asset = objectlist.Value;
