...
namespace NpcApi
{
    static class ItsDaFuckinShopApi
    {
        ...
        public static GameObject SetUpShop(string name, string prefix, List<string> idleSpritePaths, int idleFps, List<string> talkSpritePaths, int talkFps, GenericLootTable lootTable, CustomShopItemController.ShopCurrencyType currency, string runBasedMultilineGenericStringKey,
            ...
            Func<PlayerController, PickupObject, int, bool> OnPurchase = null, Func<CustomShopController, PlayerController, PickupObject, int, bool> OnSteal = null, string currencyIconPath = "", string currencyName = "", bool canBeRobbed = true, bool hasCarpet = false, string carpetSpritePath = "", float CarpetXOffset = 0, float CarpetYOffset = 0, bool hasMinimapIcon = false,
