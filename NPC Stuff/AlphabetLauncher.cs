...
namespace Planetside
{
    public class AlphabetController
    {
        ...
        public static string ConvertString(string text)
        {
            ...
            {
                if (referenceKeys.ContainsKey(letter)) 
                {
                    stringBuilder.Append(referenceKeys[letter]);
                }
                else
                {
        ...
        public static void GenerateLetter(string assetName, string name, char correspondingLetter)
        {
        ...
        public static Dictionary<char, string> referenceKeys = new Dictionary<char, string>();
    }
}
