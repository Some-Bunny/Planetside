...
{
    public static class BreakableAPI_Bundled
    {
        ...
        public static GameObject GenerateShadow(string spriteName, string name, tk2dSpriteCollectionData customCollection, Transform parent, Vector3 Offset)
        {
            var prefab = PrefabBuilder.BuildObject(name);

            tk2dSprite orAddComponent3 = prefab.GetOrAddComponent<tk2dSprite>();
            orAddComponent3.SetSprite(customCollection, spriteName);
            ...
            prefab.transform.position = parent.gameObject.transform.position + Offset;
            prefab.transform.parent = parent;
            DepthLookupManager.ProcessRenderer(prefab.GetComponent<Renderer>(), DepthLookupManager.GungeonSortingLayer.BACKGROUND);
            orAddComponent3.usesOverrideMaterial = true;
 
            return prefab;
        }
        #region [UNFINISHED] Door Blocker
        ...
        public static DebrisObject GenerateDebrisObject(string shardSprite, tk2dSpriteCollectionData customCollection, bool debrisObjectsCanRotate = true, float LifeSpanMin = 0.33f, float LifeSpanMax = 2f, float AngularVelocity = 540, float AngularVelocityVariance = 180f, tk2dSprite shadowSprite = null, float Mass = 1, string AudioEventName = null, GameObject BounceVFX = null, int DebrisBounceCount = 0, bool DoesGoopOnRest = false, GoopDefinition GoopType = null, float GoopRadius = 1f, bool usesWorldShader = true)
        {
            var prefab = PrefabBuilder.BuildObject(shardSprite);

            tk2dSprite tk2dsprite = prefab.AddComponent<tk2dSprite>();
            DebrisObject DebrisObj = prefab.AddComponent<DebrisObject>();
            tk2dsprite.collection = customCollection;
            tk2dsprite.SetSprite(customCollection, shardSprite);
            DebrisObj.canRotate = debrisObjectsCanRotate;
            DebrisObj.lifespanMin = LifeSpanMin;
            DebrisObj.lifespanMax = LifeSpanMax;
            DebrisObj.bounceCount = DebrisBounceCount;
